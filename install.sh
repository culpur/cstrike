...
# CStrike v2 — Generated by install.sh
# AI provider keys and scan config are managed via the web UI.
# Default credentials: cstrike / cstrike (change in production)
...
echo ""
echo -e "  ${BOLD}Default Credentials (saved in ${INSTALL_DIR}/.env):${RESET}"
echo -e "    OS Login:    cstrike / cstrike"
echo -e "    PostgreSQL:  cstrike / cstrike"
echo -e "    Redis:       cstrike"
echo -e "    Kasm VNC:    cstrike"
echo ""
